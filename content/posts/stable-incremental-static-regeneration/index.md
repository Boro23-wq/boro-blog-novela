...
<div className="Image__Small">
  <img src="./images/static-regeneration-image-1.png" alt="static-regeneration-image" />
</div>
...
<div className="Image__Small">
  <img src="./images/incremental-static-regeneration.gif" alt="incremental-static-regeneration" />
</div>
...
```js
// src: console.log(json.data.repository.issue.reactionGroups)
